...
class Queen : public Piece {
    ...
    private:
        ...
        std::vector<Square> legalDiagDests(const Square& start, const std::array<std::array<int, 8>, 8>& board);
        ...
        // Called by Queen::legalDests()
        std::vector<Square> legalStraightDests(const Square& start, const std::array<std::array<int, 8>, 8>& board);
};